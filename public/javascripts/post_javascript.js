...
$(document).ready(function(){
    load_tags();
     ...
     $('#tags_line').on('click','span',function(){$(this).remove();});
$('#tags_line').css( 'cursor', 'pointer' ); 
$('#tags_line').on('mouseenter','span',function(){ $(this).css('background','red');});
$('#tags_line').on('mouseleave','span',function(){ $(this).css('background','none');});
    })
    ...
    var post_id=page._id.toString();
        ...
        async.parallel([
            function(callback){
                ...
                Comments.count({post_id:post_id,published:true},callback)
            },
            function(callback){
...
/*var retarray=[];
 ...
 if(i==arr.length-1) console.log(retarray);
            ...
            if(err){console.log('findComments:'+err.message);

                if(page.published) res.render('post', {page: page, wysiwygAjax:'/postCom',is_comments:'none'});

            }
            else   if(page.published) {res.render('post', {page: page, wysiwygAjax:'/postCom',
                comments:result[1][0],
                offset:result[1][1],count:result[0],is_comments:'yes',pagelink:'/post/'+page._id+'/'});}
...
module.exports.redactCom=function(req,res) {
    Posts.findById(req.params.page, function (err, page) {
        ...
        async.parallel([
            ...
            else   if(page.published) {res.render('post', {page: page,  wysiwygAjax:'/redactCom/'+req.params.comment,
                comments:result[1][0],
                offset:result[1][1],count:result[0],is_comments:'yes',pagelink:'/post/'+page._id+'/'});}
...
module.exports.redactPost=function(req,res) {
    Posts.findById(req.params.page, function (err, page) {
        ...
        async.parallel([
            ...
            else   if(page.published) {res.render('post', {page: page,  wysiwygAjax:'/redactPost/'+req.params.page,
                comments:result[1][0],
                offset:result[1][1],count:result[0],is_comments:'yes',pagelink:'/post/'+page._id+'/'});}

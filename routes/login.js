...
module.exports.getLogin=function(req,res) {
    ...
    res.render('login',{target:'login',formTitle:"Панель входа",scriptUrl:'/login',winHref:redirect});
};
module.exports.getRegister=function(req,res) {
    res.render('login',{target:'register',formTitle:"Регистрация",scriptUrl:'/register',winHref:'/emailCheck'});
};
...
module.exports.postRegister=function(req,res,next) {
   ...
   var randomstring = require("randomstring").generate();
    User.findOne({status:randomstring}, function(err, string) {
...
module.exports.emailValidate=function(req,res) {
  ...
  //  res.send(req.params.secret);
    User.findOne({status:req.params.secret}, function(err, user) {
